...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleAccountCannotBeClosedException(AccountCannotBeClosedException exception) {
        ErrorResponse errorResponse = new ErrorResponse(HttpStatus.CONFLICT.value(), exception.getMessage());
        return new ResponseEntity<>(errorResponse, HttpStatus.CONFLICT);
    }
    ...
    public ResponseEntity<ErrorResponse> handleInvalidTransferAmountException(InvalidTransferAmountException exception) {
        ErrorResponse errorResponse = new ErrorResponse(HttpStatus.CONFLICT.value(), exception.getMessage());
        return new ResponseEntity<>(errorResponse, HttpStatus.CONFLICT);
    }

    @ExceptionHandler(InvalidTransferException.class)
    public ResponseEntity<ErrorResponse> handleInvalidTransferException(InvalidTransferException exception) {
        ErrorResponse errorResponse = new ErrorResponse(HttpStatus.CONFLICT.value(), exception.getMessage());
        return new ResponseEntity<>(errorResponse, HttpStatus.CONFLICT);
    }
    ...
    @ExceptionHandler(AssetDataNotFoundException.class)
    public ResponseEntity<ErrorResponse> handleAssetDataNotFoundException(AssetDataNotFoundException exception) {
        ErrorResponse errorResponse = new ErrorResponse(HttpStatus.NOT_FOUND.value(), exception.getMessage());
        return new ResponseEntity<>(errorResponse, HttpStatus.NOT_FOUND);
    }
    ...
    @ExceptionHandler(AssetDataFetchException.class)
    public ResponseEntity<ErrorResponse> handleAssetDataFetchException (AssetDataFetchException exception) {
    ...
    public ResponseEntity<ErrorResponse> handleAccessForbiddenException (AccessForbiddenException exception) {
